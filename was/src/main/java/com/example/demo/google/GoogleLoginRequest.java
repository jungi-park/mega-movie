...
public class GoogleLoginRequest {
	...
	public GoogleLoginRequest(String clientId, String redirectUri, String clientSecret, String responseType,
			String scope, String code, String accessType, String grantType, String state, String includeGrantedScopes,
	...
	public String toString() {
		return "GoogleLoginRequest [clientId=" + clientId + ", redirectUri=" + redirectUri + ", clientSecret="
				+ clientSecret + ", responseType=" + responseType + ", scope=" + scope + ", code=" + code
